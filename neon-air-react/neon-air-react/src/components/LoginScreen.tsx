...
export default function LoginScreen({ onLogin, onSignup, onResetPassword, loading }: Props) {
  ...
  return (
    <div className="absolute inset-0 z-[60] overflow-hidden bg-[#050608] flex items-center justify-center">
      {/* ambient light field */}
      <div
        className="auth-blob-1 pointer-events-none absolute -top-1/4 -left-1/4 w-[70vw] h-[70vw] rounded-full opacity-[0.16] blur-[110px]"
        style={{ background: 'radial-gradient(circle, #00dcff, transparent 65%)' }}
      />
      <div
        className="auth-blob-2 pointer-events-none absolute -bottom-1/4 -right-1/4 w-[65vw] h-[65vw] rounded-full opacity-[0.14] blur-[110px]"
        style={{ background: 'radial-gradient(circle, #ff2ee0, transparent 65%)' }}
      />
